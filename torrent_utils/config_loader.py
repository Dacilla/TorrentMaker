...
CONFIG_STRUCTURE = {
    'DEFAULT': {
        ...
        'ONLYIMAGE_API': '',
        'CATBOX_HASH': '',
        '# slow.pics (Optional Auth Cookies)': '',
        'SLOWPICS_REMEMBER_ME': 'c1VYZmVtM2p4M0daeDR4bVpUd3Y6MkxSTmRRcWVnOW9PbmR5QW5BZUE',
        'SLOWPICS_SESSION': '3AFE7D7E39201A44CB5610FDAFE68CF6',
        '# Tracker APIs': '',
        'HUNO_API': '',
        'RED_API': '',
        'OPS_API': '',
        '# Tracker URLs': '',
        'HUNO_ANNOUNCE_URL': 'https://hawke.uno/YOUR_PASSKEY/announce',
        'RED_ANNOUNCE_URL': 'https://flacsfor.me/YOUR_PASSKEY/announce',
        'OPS_ANNOUNCE_URL': 'https://home.opsfet.ch/YOUR_PASSKEY/announce',
        '# Paths': '',
        'SEEDING_DIR': '',
        '# Seedbox FTP Settings': '',
        'SEEDBOX_REMOTE_PATH': '/downloads/qbittorrent',
        'SEEDBOX_HOST': '',
        'SEEDBOX_PORT': '',
        'SEEDBOX_FTP_USER': '',
